...
function Footer() {
  return (
    <div id="footer">
      ...
      <div id="links">
        <a href="mailto:sofiajayaswal@gmail.com">
          <img src={emailIcon} alt="" />
        </a>
        <a target="_blank" href="https://github.com/sofiapjayaswal" rel="noreferrer">
          <img src={gitIcon} alt="" />
        </a>
        <a target="_blank" href="https://www.linkedin.com/in/sofiajayaswal/" rel="noreferrer">
